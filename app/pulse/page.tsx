...
export function generateMetadata(): Metadata {
  if (isNewsroomLifecycleCutoverEnabled()) {
    return {
...
/**
 * Pulse remains at its current public methodology URL until the single
 * lifecycle cutover is explicitly enabled. The cutover then removes it;
 * no independent Pulse release switch exists.
 */
        ...
        <div className={styles.shell}>
          ...
          <div className={styles.heroGrid}>
            ...
            <div className={styles.status}>
              ...
              <p>
                This page documents the intended safeguards while the method
                is being tested.
              </p>
            </div>
          </div>
      ...
      <section className={styles.available} aria-labelledby="available-heading">
        <div className={styles.shell}>
          ...
          <h2 id="available-heading">
            Use the published evidence while Pulse is tested.
          </h2>
